...
public static void main(String[] args)
{
   ...
   System.out.println("Average area: " + (int)avg);
   System.out.println("Expected: 239950");
   System.out.println("");
   double maxData = Data.max(countries);
   System.out.println("Maximum area: " + (int)maxData);
   ...
   System.out.println("Average balance: " + (int)avg);
   System.out.println("Expected: 239950");
   System.out.println("");
   maxData = Data.max(bank);
   System.out.println("Maximum balance: " + (int)maxData);
   System.out.println("Expected: 513120");
   System.out.println("");
   ...
   System.out.println("Average grade: " + (int)avg);
   System.out.println("Expected: 78");
   System.out.println("");
   maxData = Data.max(quizzes);
   System.out.println("Maximum grade: " + (int)maxData);
